...
export default function PeerReviewProcess() {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center min-h-screen  px-4 my-4 w-[99%] md:w-[80%]"
    >
      <Card className=" bg-white shadow-lg rounded-2xl p-6">
        <CardContent>
          <h2 className="text-3xl w-full  font-bold text-center text-gray-800 mb-4">
            Peer Review Process
          </h2>
